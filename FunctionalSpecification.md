...
| 35 |   F_Admin_Panel_3a      | Администраторы должны иметь возможность добавлять новые устройства в систему через административный интерфейс,.  |
| 36 |   F_Admin_Panel_3b      | Администраторы должны иметь возможность удалять устройства из системы через административный интерфейс.        |
| 37 |   F_Admin_Panel_3c      | Администраторы должны иметь возможность обновлять информацию о существующих устройствах через административный интерфейс. |
| 38 |   F_Admin_Panel_4a      | Администраторы должны иметь возможность создавать новые аккаунты пользователей через административный интерфейс. |
| 39 |   F_Admin_Panel_4b      | Администраторы должны иметь возможность удалять аккаунты пользователей через административный интерфейс.        |
| 40 |   F_Admin_Panel_4c      | Администраторы должны иметь возможность изменять права доступа пользователей через административный интерфейс.   |
